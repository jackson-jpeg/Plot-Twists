      ...
      <div className="container max-w-md">
        ...
        >
          ...
          >
            ...
            <h1 className="text-2xl font-display font-bold text-white tracking-wide mb-1">ADMIT ONE</h1>
            <p className="font-script text-lg" style={{ color: 'rgba(255,255,255,0.8)' }}>Welcome back to the show</p>
          </div>
