...
const authErrorMessages: Record<string, string> = {
  ...
  'auth/operation-not-allowed': 'Phone authentication is not enabled. Please check Firebase Console settings',
  'auth/invalid-app-credential': 'App verification failed. Please refresh the page and try again',
  'auth/missing-recaptcha-token': 'Security verification failed. Please refresh and try again',
